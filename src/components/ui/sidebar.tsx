import { createContext, useCallback, useContext, useEffect, useState, useMemo, CSSProperties, ButtonHTMLAttributes, HTMLAttributes, InputHTMLAttributes, ReactNode } from "react";
...
function SidebarFooter({ className, ...props }: SidebarHeaderProps) {
  return <div data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...props} />;
}

interface SidebarSeparatorProps extends HTMLAttributes<HTMLDivElement> {}
...
function SidebarContent({ className, ...props }: SidebarHeaderProps) {
  return (
    <div
...
function SidebarGroup({ className, ...props }: SidebarHeaderProps) {
...
function SidebarGroupContent({ className, ...props }: SidebarHeaderProps) {
...
interface SidebarMenuButtonProps extends ButtonHTMLAttributes<HTMLButtonElement>, VariantProps<typeof sidebarMenuButtonVariants> {
  asChild?: boolean;
  isActive?: boolean;
...
interface SidebarMenuBadgeProps extends HTMLAttributes<HTMLDivElement> {
  children?: ReactNode;
}
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }: HTMLAttributes<HTMLDivElement> & { showIcon?: boolean }) {
...
function SidebarMenuSub({ className, ...props }: SidebarMenuProps) {
  return (
    <ul
...
function SidebarMenuSubItem({ ...props }: SidebarMenuItemProps) {
  return <li {...props} />;
}

interface SidebarMenuSubButtonProps extends HTMLAttributes<HTMLAnchorElement> {
  asChild?: boolean;
  size?: "sm" | "md";
  isActive?: boolean;
}

function SidebarMenuSubButton({ asChild = false, size = "md", isActive, className, ...props }: SidebarMenuSubButtonProps) {
